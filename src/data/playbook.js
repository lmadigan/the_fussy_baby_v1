...
export const CAUSES = [
  {
    ...
    foodListIntro: "Cow's milk is consistently reported first. Beyond that, studies vary, but these foods are reported most often in roughly this order:",
    commonFoods: [
      { name: "Cow's milk protein", detail: "The food protein most often linked to reactions in breastfed babies." },
      { name: "Egg protein", detail: "One of the next most frequently reported triggers after cow's milk." },
      { name: "Soy protein", detail: "Another common trigger that is often considered alongside dairy." },
      { name: "Beef", detail: "A less common trigger that has been reported in breastfed babies." },
      { name: "Wheat", detail: "A documented trigger, although it is reported much less often than cow's milk." },
      { name: "Fish", detail: "Reported in a smaller number of babies." },
      { name: "Corn", detail: "Another possible but less commonly reported trigger." },
    ],
  ...
  },
  {
    ...
    whatIsIt: "Reflux is when milk moves back up from the stomach into the esophagus, the tube between the mouth and stomach. Many babies spit up and remain comfortable, continue feeding, and grow normally. Silent reflux is the same movement, but the milk is swallowed again instead of coming out of the mouth. What matters most is not whether you can see spit-up, but whether your baby seems uncomfortable, struggles to feed, takes in less milk, or is not growing as expected. Arching and fussiness can also be caused by fast milk flow, latch problems, or food protein sensitivity, so those signs alone cannot tell you that reflux is the cause.",
