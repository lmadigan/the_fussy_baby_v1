...
export const PROTOCOL_STEPS = [
  {
    ...
    short: "Before changing your diet or switching formulas, check for physical issues that may be affecting how your baby feeds. These can be easy to miss during a standard pediatric exam.",
    reviewAfterDays: 7,
    reviewWindow: "Review 1–2 weeks after making the agreed feeding change",
    checklist: [
      "Schedule a feeding assessment with a board-certified lactation consultant (IBCLC) who has experience with tongue and lip ties. Ask them to watch a full feed and evaluate your baby's latch, milk transfer, and comfort.",
      ...
      "If your baby takes a bottle, check that the nipple flow isn't too fast. Coughing, gulping, pulling away, or milk spilling from their mouth may be signs to try a slower-flow nipple and paced feeding.",
      "If reflux is suspected, try a laid-back breastfeeding position, with you comfortably reclined and your baby resting at an incline against your body. After feeds, hold your baby upright for 20–30 minutes when practical.",
      "Check for clicking, dimpling cheeks, or flared lips during feeds. These can be signs that your baby is not maintaining a strong seal and may be swallowing more air.",
      "Use the feeding assessment, not appearance alone, to guide next steps. Before any procedure or bodywork, ask what feeding problem it is expected to improve and how progress will be measured.",
    ],
    reviewQuestion: "After making the agreed feeding change, are feeds more comfortable and is your baby swallowing less air or seeming less fussy afterward?",
    contactSooner: [
      "Your baby is hard to wake, has fewer wet diapers, repeatedly coughs or chokes during feeds, or is taking much less milk.",
      "You are concerned about breathing, weight gain, or a persistent head tilt or side preference.",
    ],
    outcomeGuidance: {
