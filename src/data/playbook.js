...
export const STATUSES = [
  ...
  { id: "in_progress", label: "In Progress", tone: "signal" },
  { id: "complete", label: "Complete", tone: "calm" },
  { id: "low_priority", label: "Low Priority", tone: "neutral" },
  { id: "revisit", label: "Revisit", tone: "warm" },
];
