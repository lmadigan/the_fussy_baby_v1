...
const TABS = [
  ...
  { id: "learn", label: "Learn", icon: "M12 6.5C10.5 5 8.5 4.5 5 4.5v13c3.5 0 5.5.5 7 2 1.5-1.5 3.5-2 7-2v-13c-3.5 0-5.5.5-7 2Zm0 0v13" },
  { id: "history", label: "History", icon: "M12 8v4.5l3 2M12 20a8 8 0 1 0-8-8m0 0H2m2 0 2-2" },
];
